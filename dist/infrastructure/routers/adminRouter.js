...
const adminRoutes = (dependencies) => {
    const { loginAdmin, adminAddMemberShip, getMemberShip, getMemberShipById, deleteMembershipById, updateMemberShipById } = (0, controllers_1.adminController)(dependencies);
